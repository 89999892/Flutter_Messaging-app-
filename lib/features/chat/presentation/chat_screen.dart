...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _startVideoCall(BuildContext context, String currentUserId) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BlocProvider(
          create: (context) => sl<VideoCallBloc>()
            ..add(InitiateVideoCall(
              callerId: currentUserId,
              calleeId: widget.otherUserId,
            )),
          child: const VideoCallScreen(
            callId: '', // Will be generated by BLoC
            isOutgoing: true,
          ),
        ),
      ),
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                IconButton(
                  ...
                  onPressed: () => _startVideoCall(context, currentUserId),
                ),
